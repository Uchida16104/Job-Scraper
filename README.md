...
5. ダウンロードしたCSVファイルを[Deterministic Processor(英語版)](https://github.com/Uchida16104/Deterministic-Processor)で分析・抽出
...
## 注意
- ***結果データは必ずしも保証されたものではありません。<br />必ず、分析元の求人サイトから直接再確認する事をお勧めします。***
